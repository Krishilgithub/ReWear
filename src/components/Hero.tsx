				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="animate-fade-in">
						...
						<p className="text-lg text-muted-foreground mb-8 max-w-lg">
							Join ReWear's community-driven clothing exchange. Swap items
							directly with others or use our point system to discover your next
							favorite piece – all while reducing textile waste.
						</p>

						<div className="flex flex-col sm:flex-row gap-4 mb-12">
							<Button
								size="lg"
								className="gradient-sage text-white hover:opacity-90 group"
							...
							<div className="grid grid-cols-2 gap-4 mb-6">
								<div className="space-y-4">
									...
									<div className="bg-white rounded-2xl p-6 shadow-lg hover-lift">
										...
										<p className="text-sm text-muted-foreground">
											Reduce waste and give clothes a second chance
										</p>
									</div>
								</div>
								<div className="space-y-4 pt-8">
									<div className="bg-white rounded-2xl p-6 shadow-lg hover-lift">
										...
										<p className="text-sm text-muted-foreground">
											Simple process to exchange items you love
										</p>
									</div>
								</div>
							</div>
