...
const FeaturedItems = () => {
	...
	return (
		<section id="featured-items" className="py-16 bg-background">
			<div className="container">
				<div className="text-center mb-12">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Discover amazing pieces from our community. Each item has been
						carefully reviewed and is ready for its next adventure.
					</p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
					{items.map((item) => (
						<Card
							key={item.id}
							className="group hover-lift overflow-hidden border-0 shadow-md hover:shadow-lg transition-all duration-300"
						>
